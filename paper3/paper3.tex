...
However, what the adversarial loss actually enforces is that $z_y$ has the same distribution for the bags from the deployment set and the bags from the training set.
...
However, in our preliminary experiments we found this sample-wise approach to work much more poorly
...
the first of which corresponds to the aspect that is common in the two sets,
