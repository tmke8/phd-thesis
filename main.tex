...
\newcommand{\myVersion}{Thesis v0.2}
...
\cleardoublepage
\ctparttext{
  The first part covers the introduction, the related work and a summary of the work presented in part~\ref{pt:main}.
}
...
\cleardoublepage
\ctparttext{
  The main part comprises two peer-reviewed publications and one submitted paper currently under review.
