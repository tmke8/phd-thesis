...
\newcommand\entry[2]{%
\hangindent\glossarylabelindent\noindent\makebox[\glossarylabelindent][l]{##1\quad}\ignorespaces##2\par\addvspace{9pt}}%
...
\part{Part II}\label{pt:main}
\include{ch/3-target-labels}
\include{ch/4-nifr}
\include{ch/5-zsf}

\cleardoublepage
\part{Part III}\label{pt:end}
