...
\begin{figure*}[tb]
    ...
    \subfloat[cFlow model.]{%
        \scalebox{0.33}{\includegraphics[width=\textwidth]{paper2/Figures/inn_diagram_u.pdf}}%
        \label{fig:inn_diagram}
    }
    \hfill
    \subfloat[cVAE model.]{%
        \scalebox{0.4}{\includegraphics[width=\textwidth]{paper2/Figures/cvae_diagram_u.pdf}}%
