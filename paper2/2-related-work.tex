\begin{figure*}[!htb]
    ...
    \subfloat[Samples from the cMNIST training set, $\sigma=0$.]{%
        \scalebox{0.3}{\includegraphics[width=\textwidth]{./Images/cmnist/cflow_original_task_x_scale_0.png}}%
    ...
    \subfloat[$x_u$ null-samples from the cFlow model.]{%
        \scalebox{0.3}{\includegraphics[width=\textwidth]{./Images/cmnist/cflow_task_xy_scale_0.png}}%
        \label{fig:cflow_cmnist_y}
    }
    \hfill
    \subfloat[$x_b$ null-samples from the cFlow model.]{%
        \scalebox{0.3}{\includegraphics[width=\textwidth]{./Images/cmnist/cflow_task_xs_scale_0.png}}%
...
\citet{ZemWuSwePitetal13} was the first to propose the learning of fair representations which allow for transfer to new classification tasks.
