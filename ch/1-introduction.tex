...
% -  perfect bags
%     - I
%         - developed the idea of distribution matching
%         - developed the idea of clustering an auxiliary set
%     - Vika
%         - head the idea for how to frame the method
%         - worked on introduction/related work/method
%     - Myles
%         - ran experiments
%         - came up with NN architecture
%         - came up with idea of bags-of-batches
%     - Novi
%         - combined the two pieces that I had into a whole
\begin{itemize}
  \item I developed the idea of distribution matching as an extension of the previous paper. In addition, I tried to achieve similar goals by applying clustering to
\end{itemize}
