...
The fairness definition with the clearest interpretation in the described setup of label bias and sampling bias is \acfi{DP},
...
In particular, for \ac{EOpp}, the \acfip{TPR} need to be the same for all demographic groups
...
\Rangechapref{ch:paper1}{ch:paper3} reproduce the publications listed in the previous section.
