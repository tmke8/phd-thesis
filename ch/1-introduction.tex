...
\thomas{should there be something about fairness metrics here?}

\thomas{Possible segway:}
While we could determine how strongly a classifier has been affected by these biases
