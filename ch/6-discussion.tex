...
that labor-intensive labeling is not needed and so vast amounts of existing, unlabelled data can be put to good use.
...
So, when asked to summarise a text, GPT does not give the \emph{best} summary;
