...
is that it is not enough to remove the discriminatory features
...
Thus, it measures the violation of \ac{DP} (where the rate of positive predictions would the same for all groups).
...
\section{Fair representation}\label{sec:fair-representation}
...
\citet{kleinberg2016inherent} formalised three different fairness conditions.
