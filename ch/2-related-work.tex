...
\section{\NoCaseChange{Two views of the dataset bias problem}}\label{two-views-of-the-dataset-bias-problem}
...
and they also perform experiments on Colored MNIST (see above).
...
This idea is formulated as a (untractable) bi-level, constrained optimization problem,
...
experiments are performed on a synthetic dataset and Colored MNIST.
...
in their setting, the underlying unbiased labels become corrupted by a biased labeler,
...
this models general inaccuracies in the labeling process and does not introduce bias yet.
...
Finally, labeling bias is added, by flipping labels for one of the demographic groups (\eg, \(s=0\)),
