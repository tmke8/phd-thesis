...
\begin{figure}[tbp]
  \resizebox{\textwidth}{!}{
    ...
    [methods for algorithmic fairness
      ...
      [
        [change to\\training\\procedure, line width = 2pt
          [modified\\sampling]
          [
            [change to loss
              [change of\\optimisation target, draw=blue]
  ...
  \caption{%
    ...
    to which the proposed models in this thesis belong (see \chapref{ch:content} for details).
