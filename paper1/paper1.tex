...
\begin{figure}[t]
  \begin{center}
    \centerline{\includegraphics[width=0.98\columnwidth]{paper1/figures/adult_tar_choice.eps}}
...
However, the only real requirement is reasonably-well calibrated probabilities from the used model,
